...

{
    ...
    gluOrtho2D(-12,38,-19,14);//specifies range
    ...
    glBegin(GL_POLYGON);//Ground portion
    ...
    glColor3ub(162, 116, 36);//1st House
    ...
    glPushMatrix();//boat-1 speed left to right
    ...
    glPushMatrix();//boat-2 motion right to left
...

{
    ...
    glutCreateWindow(" Village Of Dream ");
